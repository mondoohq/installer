...
"""RHEL/Fedora/Rocky/Alma dnf package manager implementation."""
...
class DnfPackageManager(PackageManager):
    """RHEL/Fedora/Rocky/Alma dnf package manager."""
