...
run_login_cmd() {
  ...
  # NOTE: On-premise builds replace "releases.mondoo.com" and "install.mondoo.com"
  # throughout this file. The _standard_host check is deliberately split so the
  # replacement does NOT match it. This lets the case fall through to set the
  # URL for on-premise.
