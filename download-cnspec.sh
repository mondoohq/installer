...
# curl -sSL https:/cnspec.com/download.sh | sh -
# 
...
purple_bold "cnspec Binary Download Script"
purple "
                        .-.            
                        : :            
,-.,-.,-. .--. ,-.,-. .-' : .--.  .--. ™
...
echo -e "\nWelcome to the cnspec Binary Download Script. It tries to auto-detect your 
...
purple_bold "\nThank you for downloading cnspec!"
purple_bold "\nRun cnspec scan local to get started"
echo -e "
